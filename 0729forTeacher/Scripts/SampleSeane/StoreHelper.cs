...
public class StoreHelper : MonoBehaviour
{
        ...
        private string subscriptionStoreId = "getsugaku1900";
...

        {
              ...
              statustext.text="SetupSubscriptionInfoAsync";
                GameObject PurchaseRequestBord = GameObject.Find("PurchaseRequestBord");
            ...
            if (userOwnsSubscription)
            {
                ...
                {
                    PurchaseRequestBord.SetActive(false);
