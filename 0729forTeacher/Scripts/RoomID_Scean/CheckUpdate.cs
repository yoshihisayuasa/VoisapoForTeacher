...
public class CheckUpdate : MonoBehaviour
{
    ...
    IEnumerator GetText()
    {
        UnityWebRequest www = UnityWebRequest.Get("https://voisapo.hatenablog.com/entry/2023/04/10/114942");
    ...
    public void UpdateButton()
    {
        ...
        url = "ms-windows-store://pdp/?ProductId=9NSN110V1HC2";
#endif

#if UNITY_STANDALONE_OSX || UNITY_EDITOR_OSX
            url = "https://apps.apple.com/app/apple-store/id6443791224";
#endif
