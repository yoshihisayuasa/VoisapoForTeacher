...
namespace UniPay
{
    ...
    public class DBManager : MonoBehaviour
    {
        ...
        void InitDB()
        {
            ...
            List<IAPCurrency> currencies = IAPManager.Instance.asset.currencyList;
        ...
        public static int GetPurchase(string productID)
        {
            ...
            else
            {
                ...
                if (product != null && product.IsVirtual() && product.type != ProductType.Consumable && product.priceList.Count == 0)
                    return 1;
            }
        ...
        {
            IAPCurrency currency = IAPManager.Instance.asset.currencyList.Find(x => x.ID == currencyID);
        ...
        public static void Save(string key = "")
        {
            ...
            switch (Instance.storageTarget)
            {
                ...
                case StorageTarget.PersistentDataPath:
                    ...
                    {
                        case EncryptionType.None:
                            byte[] dataAsBytes1 = Encoding.ASCII.GetBytes(str);
                            try { File.WriteAllBytes(Application.persistentDataPath + "/" + prefsKey + persistentFileExt, dataAsBytes1); }
                            catch (Exception) { }
                            break;
                        ...
                        case EncryptionType.Internal:
                            ...
                            byte[] dataAsBytes2 = Encoding.ASCII.GetBytes(str);
                            try { File.WriteAllBytes(Application.persistentDataPath + "/" + prefsKey + persistentFileExt, dataAsBytes2); }
                            catch (Exception) { }
                            break;
