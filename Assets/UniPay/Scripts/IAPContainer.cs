...
namespace UniPay
{
    ...
    {
        /// <summary>
        /// The category on the IAPSettings asset this container should use.
        /// </summary>
        ...
        {
            List<IAPProduct> products = IAPManager.Instance.asset.productList.FindAll(x => x.category.referenceID == this.category.referenceID);
            ...
            for (int i = 0; i < products.Count; i++)
            {
                ...
                //check overrides
                IAPCategory category = IAPManager.Instance.asset.categoryList.Find(x => x.referenceID == product.category.referenceID);
