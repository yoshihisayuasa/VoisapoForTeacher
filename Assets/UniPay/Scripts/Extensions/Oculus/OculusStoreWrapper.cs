...
namespace UniPay
{
    ...
    /// <summary>
    /// Wrapper defining instance and store name for Oculus.
    /// </summary>
    class OculusStoreWrapper : IStoreWrapper
    {
        public string name { get; }
        private string _name => IAPPlatform.OculusStore.ToString();

        public Store instance => _instance;
        private readonly OculusStore _instance;
        

        public OculusStoreWrapper(OculusStore instance)
        {
            name = _name;
            _instance = instance;
        }
